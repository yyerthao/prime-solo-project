...
INSERT INTO "dream" (title, date, image, details, user_id, genre_id)
VALUES ('Babies', '08-29-2020', 'https://media.phillyvoice.com/media/images/The_reason_babies_hiccup_so_mu.2e16d0ba.fill-1200x630-c0.jpg', 'I dreamt about having babies again but holy moly, no more kids for this mama.', 2, 1); 


INSERT INTO "dream" (title, date, image, details, user_id, genre_id)
VALUES ('Scary Stories', '04-09-2018', 'https://pyxis.nymag.com/v1/imgs/ec9/989/f972cf762131d519bc0b10676a1e5ac964-05-scary-stories-to-tell-in-the-dark-led.rsocial.w1200.jpg', 'Dreamt about my favorite series of scary stories growing up and I was actually in one of them. I ran from the ghost but I was not able to move anywhere at all.', 2, 3);
...
INSERT INTO "dream_genre" ("dream_id", "genre_id") VALUES (3, 2);
INSERT INTO "dream_genre" ("dream_id", "genre_id") VALUES (4, 3);
...
SELECT title, date, image, details, genre.name FROM dream_genre 
